...
req=reek.Session()
os.system('clear')
title=pyfiglet.figlet_format("WELCOM TO SPAMSMS BY ZHICCO")
p = "\33[37;1m"
h = "\33[32;1m"
m = "\33[31;1m"
ber=0
...
def cok():
	while True:
		try:
			...
			asu=a[0:2]
			if a in(""," "):print("[!] Jangan Kosong no nya")
			elif "08" not in asu:print("[!] Gunakan Nomer 08xxx\n")
			elif len(a)<=10:print("[!] Nomer Harus Lebih Dari 10 Angka")
			elif a=="083805850124":print("[!] Anda Tidak Bisa Spam Yang Punya Script Goblok!\n")
			else:
				try:
